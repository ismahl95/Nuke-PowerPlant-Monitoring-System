...
public class NuclearPlantController {
    ...
    /*
     * @PostMapping
     * public ResponseEntity<NuclearPlantDTO> createNuclearPlant(@RequestBody
     * NuclearPlantDTO nuclearPlantDTO) {
     * NuclearPlantDTO createdNuclearPlant =
     * nuclearPlantService.createNuclearPlant(nuclearPlantDTO);
     ...
     * NuclearPlantDTO updatedNuclearPlant =
     * nuclearPlantService.updateNuclearPlant(id, nuclearPlantDTO);

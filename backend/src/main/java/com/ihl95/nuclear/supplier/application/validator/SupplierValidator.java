 ...
 *
 * Validador abstracto para proveedores usando cadena de responsabilidad.
 * Cada validador:
...
public abstract class SupplierValidator {
    ...
    private static final Logger logger = LoggerFactory.getLogger(SupplierValidator.class);

    protected SupplierValidator next;
     ...
     */
    public SupplierValidator setNext(SupplierValidator next) {
        this.next = next;
        return this;
    }
     ...
     */
    public final ValidationResult validate(SupplierDTO dto) {
     ...
     */
    protected abstract ValidationResult doValidate(SupplierDTO dto);
}
